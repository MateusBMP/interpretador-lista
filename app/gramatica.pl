...
funcao(Palavra,Cauda,Erro,FinalErro) :- function(Palavra,Cauda0), id(Cauda0,Cauda1,Erro,FinalErro0), incSecVariavel(_), parametros(Cauda1,Cauda2,FinalErro0,FinalErro1), doisPontos(Cauda2,Cauda), setError('<tipo-funcao> esperado após <dois-pontos> em <funcao>.',Cauda,NovoErro), append([NovoErro],FinalErro1,FinalErro), !.
funcao(Palavra,Cauda,Erro,FinalErro) :- function(Palavra,Cauda0), id(Cauda0,Cauda1,Erro,FinalErro0), incSecVariavel(_), parametros(Cauda1,Cauda,FinalErro0,FinalErro1), setError('<dois-pontos> esperado após <parametros> em <funcao>.',Cauda,NovoErro), append([NovoErro],FinalErro1,FinalErro), !.
funcao(Palavra,Cauda,Erro,FinalErro) :- function(Palavra,Cauda0), id(Cauda0,Cauda,Erro,FinalErro0), incSecVariavel(_), setError('<parametros> esperado após <id> em <funcao>.',Cauda,NovoErro), append([NovoErro],FinalErro0,FinalErro), !.
...
procedimento(Palavra,Cauda,Erro,FinalErro) :- procedure(Palavra,Cauda0), id(Cauda0,Cauda1,Erro,FinalErro0), incSecVariavel(_), parametros(Cauda1,Cauda,FinalErro0,FinalErro1), setError('<ponto-e-virgula> esperado após <parametros> em <procedimento>.',Cauda,NovoErro), append([NovoErro],FinalErro1,FinalErro), !.
procedimento(Palavra,Cauda,Erro,FinalErro) :- procedure(Palavra,Cauda0), id(Cauda0,Cauda,Erro,FinalErro0), incSecVariavel(_), setError('<parametros> esperado após <id> em <procedimento>.',Cauda,NovoErro), append([NovoErro],FinalErro0,FinalErro), !.
