...
setVariavel(Variavel) :- string_chars(String,Variavel), get_flag(secVariavel, Sessao), assertz(variavel(String, Sessao)).
unsetVariavel(Variavel) :- string_chars(String,Variavel), get_flag(secVariavel, Sessao), retract(variavel(String, Sessao)).
isVariavel(Variavel) :- get_flag(secVariavel, Sessao), isVariavel(Variavel, Sessao).
isVariavel(Variavel, Sessao) :- string_chars(String,Variavel), variavel(String, Sessao).

incSecVariavel(Id) :- flag(secVariavel, Id, Id+1).
decSecVariavel(Id) :- flag(secVariavel, Id, Id-1).

% Controle de rotinas. É reescrito via assert e retract
:- dynamic rotina/1.

setRotina(Rotina) :- string_chars(String,Rotina), assertz(rotina(String)).
unsetRotina(Rotina) :- string_chars(String,Rotina), retract(rotina(String)).
isRotina(Rotina) :- string_chars(String,Rotina), rotina(String).
...
termo(Palavra,Cauda,Erro,FinalErro) :- id(Palavra,Cauda,Erro,FinalErro), selecionada(Palavra,Cauda,[],Selecionada), isVariavel(Selecionada), !.
...
expressao_num(Palavra,Cauda,Erro,FinalErro) :- id(Palavra,Cauda0,Erro,FinalErro0), selecionada(Palavra,Cauda0,[],Selecionada), isRotina(Selecionada), argumentos(Cauda0,Cauda,FinalErro0,FinalErro), !.
expressao_num(Palavra,Cauda,Erro,FinalErro) :- id(Palavra,Cauda,Erro,FinalErro0), selecionada(Palavra,Cauda,[],Selecionada), isRotina(Selecionada), setError('<argumentos> esperado após <id> em <expressao-num>.',Cauda,NovoErro), append([NovoErro],FinalErro0,FinalErro), !.
expressao_num(Palavra,Cauda,Erro,FinalErro) :- termo(Palavra,Cauda,Erro,FinalErro), !.
expressao_num(Palavra,Cauda,Erro,FinalErro) :- id(Palavra,Cauda,Erro,FinalErro0), setError('<id> não é uma variável ou rotina declarada em <expressao-num>.',Cauda,NovoErro), append([NovoErro],FinalErro0,FinalErro).
...
funcao(Palavra,Cauda,Erro,FinalErro) :- function(Palavra,Cauda0), id(Cauda0,Cauda1,Erro,FinalErro0), selecionada(Cauda0,Cauda1,[],Selecionada), setRotina(Selecionada), incSecVariavel(_), parametros(Cauda1,Cauda2,FinalErro0,FinalErro1), doisPontos(Cauda2,Cauda3), tipo_funcao(Cauda3,Cauda4), pontoEVirgula(Cauda4,Cauda5), corpo(Cauda5,Cauda6,FinalErro1,FinalErro2), pontoEVirgula(Cauda6,Cauda7), decSecVariavel(_), rotina(Cauda7,Cauda,FinalErro2,FinalErro), !.
funcao(Palavra,Cauda,Erro,FinalErro) :- function(Palavra,Cauda0), id(Cauda0,Cauda1,Erro,FinalErro0), selecionada(Cauda0,Cauda1,[],Selecionada), setRotina(Selecionada), incSecVariavel(_), parametros(Cauda1,Cauda2,FinalErro0,FinalErro1), doisPontos(Cauda2,Cauda3), tipo_funcao(Cauda3,Cauda4), pontoEVirgula(Cauda4,Cauda5), corpo(Cauda5,Cauda6,FinalErro1,FinalErro2), pontoEVirgula(Cauda6,Cauda), decSecVariavel(_), setError('<rotina> esperado após <ponto-e-virgula> em <funcao>.',Cauda,NovoErro), append([NovoErro],FinalErro2,FinalErro), !.
...
funcao(Palavra,Cauda,Erro,FinalErro) :- function(Palavra,Cauda0), id(Cauda0,Cauda1,Erro,FinalErro0), selecionada(Cauda0,Cauda1,[],Selecionada), setRotina(Selecionada), incSecVariavel(_), parametros(Cauda1,Cauda2,FinalErro0,FinalErro1), doisPontos(Cauda2,Cauda), setError('<tipo-funcao> esperado após <dois-pontos> em <funcao>.',Cauda,NovoErro), append([NovoErro],FinalErro1,FinalErro), !.
funcao(Palavra,Cauda,Erro,FinalErro) :- function(Palavra,Cauda0), id(Cauda0,Cauda1,Erro,FinalErro0), selecionada(Cauda0,Cauda1,[],Selecionada), setRotina(Selecionada), incSecVariavel(_), parametros(Cauda1,Cauda,FinalErro0,FinalErro1), setError('<dois-pontos> esperado após <parametros> em <funcao>.',Cauda,NovoErro), append([NovoErro],FinalErro1,FinalErro), !.
funcao(Palavra,Cauda,Erro,FinalErro) :- function(Palavra,Cauda0), id(Cauda0,Cauda,Erro,FinalErro0), selecionada(Cauda0,Cauda,[],Selecionada), setRotina(Selecionada), incSecVariavel(_), setError('<parametros> esperado após <id> em <funcao>.',Cauda,NovoErro), append([NovoErro],FinalErro0,FinalErro), !.
...
procedimento(Palavra,Cauda,Erro,FinalErro) :- procedure(Palavra,Cauda0), id(Cauda0,Cauda1,Erro,FinalErro0), selecionada(Cauda0,Cauda1,[],Selecionada), setRotina(Selecionada), incSecVariavel(_), parametros(Cauda1,Cauda2,FinalErro0,FinalErro1), pontoEVirgula(Cauda2,Cauda3), corpo(Cauda3,Cauda4,FinalErro1,FinalErro2), pontoEVirgula(Cauda4,Cauda5), decSecVariavel(_), rotina(Cauda5,Cauda,FinalErro2,FinalErro), !.
procedimento(Palavra,Cauda,Erro,FinalErro) :- procedure(Palavra,Cauda0), id(Cauda0,Cauda1,Erro,FinalErro0), selecionada(Cauda0,Cauda1,[],Selecionada), setRotina(Selecionada), incSecVariavel(_), parametros(Cauda1,Cauda2,FinalErro0,FinalErro1), pontoEVirgula(Cauda2,Cauda3), corpo(Cauda3,Cauda4,FinalErro1,FinalErro2), pontoEVirgula(Cauda4,Cauda), decSecVariavel(_), setError('<rotina> esperado após <ponto-e-virgula> em <procedimento>.',Cauda,NovoErro), append([NovoErro],FinalErro2,FinalErro), !.
procedimento(Palavra,Cauda,Erro,FinalErro) :- procedure(Palavra,Cauda0), id(Cauda0,Cauda1,Erro,FinalErro0), selecionada(Cauda0,Cauda1,[],Selecionada), setRotina(Selecionada), incSecVariavel(_), parametros(Cauda1,Cauda2,FinalErro0,FinalErro1), pontoEVirgula(Cauda2,Cauda3), corpo(Cauda3,Cauda,FinalErro1,FinalErro2), setError('<ponto-e-virgula> esperado após <corpo> em <procedimento>.',Cauda,NovoErro), append([NovoErro],FinalErro2,FinalErro), !.
procedimento(Palavra,Cauda,Erro,FinalErro) :- procedure(Palavra,Cauda0), id(Cauda0,Cauda1,Erro,FinalErro0), selecionada(Cauda0,Cauda1,[],Selecionada), setRotina(Selecionada), incSecVariavel(_), parametros(Cauda1,Cauda2,FinalErro0,FinalErro1), pontoEVirgula(Cauda2,Cauda), setError('<corpo> esperado após <ponto-e-virgula> em <procedimento>.',Cauda,NovoErro), append([NovoErro],FinalErro1,FinalErro), !.
procedimento(Palavra,Cauda,Erro,FinalErro) :- procedure(Palavra,Cauda0), id(Cauda0,Cauda1,Erro,FinalErro0), selecionada(Cauda0,Cauda1,[],Selecionada), setRotina(Selecionada), incSecVariavel(_), parametros(Cauda1,Cauda,FinalErro0,FinalErro1), setError('<ponto-e-virgula> esperado após <parametros> em <procedimento>.',Cauda,NovoErro), append([NovoErro],FinalErro1,FinalErro), !.
procedimento(Palavra,Cauda,Erro,FinalErro) :- procedure(Palavra,Cauda0), id(Cauda0,Cauda,Erro,FinalErro0), selecionada(Cauda0,Cauda,[],Selecionada), setRotina(Selecionada), incSecVariavel(_), setError('<parametros> esperado após <id> em <procedimento>.',Cauda,NovoErro), append([NovoErro],FinalErro0,FinalErro), !.
...
chamadaProcedimento(Palavra,Cauda,Erro,FinalErro) :- id(Palavra,Cauda0,Erro,FinalErro0), selecionada(Palavra,Cauda0,[],Selecionada), isRotina(Selecionada), argumentos(Cauda0,Cauda,FinalErro0,FinalErro), !.
chamadaProcedimento(Palavra,Cauda,Erro,FinalErro) :- id(Palavra,Cauda,Erro,FinalErro0), selecionada(Palavra,Cauda,[],Selecionada), isRotina(Selecionada), setError('<argumentos> esperado após <id> em <chamada-procedimento>.',Cauda,NovoErro), append([NovoErro],FinalErro0,FinalErro), !.
...
comando(Palavra,Cauda,Erro,FinalErro) :- forr(Palavra,Cauda0), abreParentese(Cauda0,Cauda1), id(Cauda1,Cauda2,Erro,FinalErro0), selecionada(Cauda1,Cauda2,[],Selecionada), isVariavel(Selecionada), doisPontosIgual(Cauda2,Cauda3), expressao(Cauda3,Cauda4,FinalErro0,FinalErro1), to(Cauda4,Cauda5), expressao(Cauda5,Cauda6,FinalErro1,FinalErro2), fechaParentese(Cauda6,Cauda7), doo(Cauda7,Cauda8), begin(Cauda8,Cauda9), sentencas(Cauda9,Cauda10,FinalErro2,FinalErro), end(Cauda10,Cauda), !.
comando(Palavra,Cauda,Erro,FinalErro) :- forr(Palavra,Cauda0), abreParentese(Cauda0,Cauda1), id(Cauda1,Cauda2,Erro,FinalErro0), selecionada(Cauda1,Cauda2,[],Selecionada), isVariavel(Selecionada), doisPontosIgual(Cauda2,Cauda3), expressao(Cauda3,Cauda4,FinalErro0,FinalErro1), to(Cauda4,Cauda5), expressao(Cauda5,Cauda6,FinalErro1,FinalErro2), fechaParentese(Cauda6,Cauda7), doo(Cauda7,Cauda8), begin(Cauda8,Cauda9), sentencas(Cauda9,Cauda,FinalErro2,FinalErro3), setError('<end> esperado após <sentencas> em <comando>.',Cauda,NovoErro), append([NovoErro],FinalErro3,FinalErro), !.
comando(Palavra,Cauda,Erro,FinalErro) :- forr(Palavra,Cauda0), abreParentese(Cauda0,Cauda1), id(Cauda1,Cauda2,Erro,FinalErro0), selecionada(Cauda1,Cauda2,[],Selecionada), isVariavel(Selecionada), doisPontosIgual(Cauda2,Cauda3), expressao(Cauda3,Cauda4,FinalErro0,FinalErro1), to(Cauda4,Cauda5), expressao(Cauda5,Cauda6,FinalErro1,FinalErro2), fechaParentese(Cauda6,Cauda7), doo(Cauda7,Cauda8), begin(Cauda8,Cauda), setError('<sentencas> esperado após <begin> em <comando>.',Cauda,NovoErro), append([NovoErro],FinalErro2,FinalErro), !.
comando(Palavra,Cauda,Erro,FinalErro) :- forr(Palavra,Cauda0), abreParentese(Cauda0,Cauda1), id(Cauda1,Cauda2,Erro,FinalErro0), selecionada(Cauda1,Cauda2,[],Selecionada), isVariavel(Selecionada), doisPontosIgual(Cauda2,Cauda3), expressao(Cauda3,Cauda4,FinalErro0,FinalErro1), to(Cauda4,Cauda5), expressao(Cauda5,Cauda6,FinalErro1,FinalErro2), fechaParentese(Cauda6,Cauda7), doo(Cauda7,Cauda), setError('<begin> esperado após <doo> em <comando>.',Cauda,NovoErro), append([NovoErro],FinalErro2,FinalErro), !.
comando(Palavra,Cauda,Erro,FinalErro) :- forr(Palavra,Cauda0), abreParentese(Cauda0,Cauda1), id(Cauda1,Cauda2,Erro,FinalErro0), selecionada(Cauda1,Cauda2,[],Selecionada), isVariavel(Selecionada), doisPontosIgual(Cauda2,Cauda3), expressao(Cauda3,Cauda4,FinalErro0,FinalErro1), to(Cauda4,Cauda5), expressao(Cauda5,Cauda6,FinalErro1,FinalErro2), fechaParentese(Cauda6,Cauda), setError('<doo> esperado após <fecha-parentese> em <comando>.',Cauda,NovoErro), append([NovoErro],FinalErro2,FinalErro), !.
comando(Palavra,Cauda,Erro,FinalErro) :- forr(Palavra,Cauda0), abreParentese(Cauda0,Cauda1), id(Cauda1,Cauda2,Erro,FinalErro0), selecionada(Cauda1,Cauda2,[],Selecionada), isVariavel(Selecionada), doisPontosIgual(Cauda2,Cauda3), expressao(Cauda3,Cauda4,FinalErro0,FinalErro1), to(Cauda4,Cauda5), expressao(Cauda5,Cauda,FinalErro1,FinalErro2), setError('<fecha-parentese> esperado após <expressao> em <comando>.',Cauda,NovoErro), append([NovoErro],FinalErro2,FinalErro), !.
comando(Palavra,Cauda,Erro,FinalErro) :- forr(Palavra,Cauda0), abreParentese(Cauda0,Cauda1), id(Cauda1,Cauda2,Erro,FinalErro0), selecionada(Cauda1,Cauda2,[],Selecionada), isVariavel(Selecionada), doisPontosIgual(Cauda2,Cauda3), expressao(Cauda3,Cauda4,FinalErro0,FinalErro1), to(Cauda4,Cauda), setError('<expressao> esperado após <to> em <comando>.',Cauda,NovoErro), append([NovoErro],FinalErro1,FinalErro), !.
comando(Palavra,Cauda,Erro,FinalErro) :- forr(Palavra,Cauda0), abreParentese(Cauda0,Cauda1), id(Cauda1,Cauda2,Erro,FinalErro0), selecionada(Cauda1,Cauda2,[],Selecionada), isVariavel(Selecionada), doisPontosIgual(Cauda2,Cauda3), expressao(Cauda3,Cauda,FinalErro0,FinalErro1), setError('<to> esperado após <expressao> em <comando>.',Cauda,NovoErro), append([NovoErro],FinalErro1,FinalErro), !.
comando(Palavra,Cauda,Erro,FinalErro) :- forr(Palavra,Cauda0), abreParentese(Cauda0,Cauda1), id(Cauda1,Cauda2,Erro,FinalErro0), selecionada(Cauda1,Cauda2,[],Selecionada), isVariavel(Selecionada), doisPontosIgual(Cauda2,Cauda), setError('<expressao> esperado após <dois-pontos-igual> em <comando>.',Cauda,NovoErro), append([NovoErro],FinalErro0,FinalErro), !.
comando(Palavra,Cauda,Erro,FinalErro) :- forr(Palavra,Cauda0), abreParentese(Cauda0,Cauda1), id(Cauda1,Cauda,Erro,FinalErro0), selecionada(Cauda1,Cauda,[],Selecionada), isVariavel(Selecionada), setError('<dois-pontos-igual> esperado após <id> em <comando>.',Cauda,NovoErro), append([NovoErro],FinalErro0,FinalErro), !.
comando(Palavra,Cauda,Erro,FinalErro) :- forr(Palavra,Cauda0), abreParentese(Cauda0,Cauda1), id(Cauda1,Cauda,Erro,FinalErro0), setError('<id> não é uma variável declarada em <comando>.',Cauda,NovoErro), append([NovoErro],FinalErro0,FinalErro), !.
comando(Palavra,Cauda,Erro,FinalErro) :- forr(Palavra,Cauda0), abreParentese(Cauda0,Cauda), setError('<id> esperado após <abre-parentese> em <comando>.',Cauda,NovoErro), append([NovoErro],Erro,FinalErro), !.
comando(Palavra,Cauda,Erro,FinalErro) :- forr(Palavra,Cauda), setError('<abre-parentese> esperado após <forr> em <comando>.',Cauda,NovoErro), append([NovoErro],Erro,FinalErro), !.
...
comando(Palavra,Cauda,Erro,FinalErro) :- id(Palavra,Cauda,Erro,FinalErro0), setError('<id> não é uma variável ou rotina declarada em <comando>.',Cauda,NovoErro), append([NovoErro],FinalErro0,FinalErro).
